  ...
  <div class="site-section">
    <div class="container">
      <div class="row block-9">
        <div class="col-md-6 pr-md-5">
          <form  action=" ttt.php "  method="POST">
            <div class="form-group">
              <input type="text" class="form-control px-3 py-3" required="required" placeholder="Họ và tên" name="hoten">
            </div>
            <div class="form-group">
              <input type="text" class="form-control px-3 py-3" required="required" placeholder="Tên Email" name="email">
            </div>
            <!-- <div class="form-group">  
              <input type="text" class="form-control px-3 py-3" placeholder="Nội dung" name="noidung">
            </div> -->
            <div class="form-group">
            <textarea cols="30" rows="7" class="form-control px-3 py-3" required="required" placeholder="Tin nhắn" name="noidung"></textarea>
            </div>
            <div class="form-group">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.616617036341!2d105.82520481440704!3d21.00799979386374!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac8041a9648d%3A0xe487dd495fdfd676!2zMTIgQ2jDuWEgQuG7mWMsIFRydW5nIExp4buHdCwgxJDhu5FuZyDEkGEsIEjDoCBO4buZaSwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1617880090768!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
      </div>
    </div>
  </div>

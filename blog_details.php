...
$ket_noi = mysqli_connect("localhost", "root", "root", "hao_givehope");
...
$noidung = mysqli_query($ket_noi, $sql);
      ...
      <div class="block-30 block-30-sm item" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-12">
              <span class="text-white text-uppercase"><?php echo $row["ngayviet"]  ;?> &mdash; by Admin</span>
              <h2 class="heading mb-5"><?php echo $row["tieude"]  ;?></h2>
            </div>
          </div>
        </div>
      </div>
